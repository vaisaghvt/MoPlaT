 ...
 */
class AgentDescriptionArea extends JFrame implements ListSelectionListener, ActionListener {
    ...
    AgentDescriptionArea(List<Agent> agents, InteractionArea interactionArea) {
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        for (int i = 0; i < agents.size(); i++) {
            if (agentList.isSelectedIndex(i)) {
                interactionArea.setAgentHighlight(i, true);

            } else {
                interactionArea.setAgentHighlight(i, false);
