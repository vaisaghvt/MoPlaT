 ...
 * @author vaisaghvt
 */
public class dataTrackPBM implements DataTracker {
...
//    private final ArrayListMultimap<Integer, Double> energySpentByAgent;
    ...
    public dataTrackPBM(RVOModel model, Collection<? extends RVOAgent> agents) {
        stepNumber = 0;
        this.model = model;
...
//            }
    ...
    public void storeToFile() {
        ...
        try {
            ...
            Logger.getLogger(dataTrackPBM.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            if (PropertySet.LATTICEMODEL) {
                writeToFileLatticeState(currentFolder + model.getScenarioName() + "_" + PropertySet.MODEL + "_" + model.seed() + "_"
