package environment.latticegas;
...
public class LatticeSpace {
    ...
    protected LatticeStep latticeStep;
    ...
    public IntGrid2D getCurrentSpace() {
        return space;
    }
    ...
    public void scheduleLattice() {
        rvoModel.schedule.scheduleRepeating(latticeStep, 1.0);
    }
...
//                                            System.out.println("right random out of all");
    ...
    public void addGoal(Goals goal) {
        ...
        GoalLines tempGoal = new GoalLines(goal.getVertices().get(0).getX(), goal.getVertices().get(0).getY(), goal.getVertices().get(1).getX(), goal.getVertices().get(1).getX());
        goals.add(tempGoal);
