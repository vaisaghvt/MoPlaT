 ...
 *
 */
public class RVO_2_1 extends RVOBase {
    ...
    public RVO_2_1() {
        super();
        orcaLines = new Vector();
    }

    public Vector<Line> getOrcaLines() {
        return orcaLines;
    }
...
//                System.out.println("Collision!!!");
        ...
        int lineFail = linearProgram2(orcaLines, maxSpeed, preferredVelocity, false, newVelocity);
    ...
    boolean linearProgram1(Vector<Line> lines, int lineNo, double radius, Vector2d optVelocity, boolean directionOpt, Vector2d result) {
    ...
    int linearProgram2(Vector<Line> lines, double radius, Vector2d optVelocity, boolean directionOpt, Vector2d result) {
    ...
    void linearProgram3(Vector<Line> lines, int numObstLines, int beginLine, double radius, Vector2d result) {
        ...
        for (int i = beginLine; i < lines.size(); i++) {
            ...
            if (det(lines.get(i).direction, tempPoint) > distance) {
                ...
                Vector<Line> projLines = new Vector<Line>();
