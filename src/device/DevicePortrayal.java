...
*/
    ...
    /* i created the deviceinspector class, cloning from agent but it didnt work. WHY!
    @Override
    public Inspector getInspector(LocationWrapper wrapper, GUIState state) {
        return new DeviceInspector(super.getInspector(wrapper, state), wrapper, state);
    }
